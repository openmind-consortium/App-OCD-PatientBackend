    ...
    class SummitProgram
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (!closeBackend)
            {
                ...
                //initialize open-ephys variables and threads
                bool streamToOpenEphys = false;
                StreamingThread sendSenseThread = null;
                StreamingThread dataSaveThread = null;
                ...
                if (!noDeviceTesting)
                {
                    ...
                    */
                    ...
                    streamToOpenEphys = parameters.GetParam("StreamToOpenEphys", typeof(bool));
                    ...
                    dataSaveThread = new StreamingThread(ThreadType.dataSave);
