...
#ifndef SUMMITSOURCEEDITOR_H_INCLUDED
#define SUMMITSOURCEEDITOR_H_INCLUDED
...
class SummitSourceEditor : public GenericEditor	//Generic Editor adds listeners for buttons and sliders.
...
public:
	...
	SummitSourceEditor(GenericProcessor* parentNode, bool useDefaultParameterEditors);
...
private:
	...
	*/
	...
	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(SummitSourceEditor);
};
